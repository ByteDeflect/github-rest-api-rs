...
impl CodeScanningOrganizationAlertItems {
    pub fn new(number: i32, created_at: String, url: String, html_url: String, instances_url: String, state: models::CodeScanningAlertState, dismissed_by: Option<models::NullableSimpleUser>, dismissed_at: Option<String>, dismissed_reason: Option<models::CodeScanningAlertDismissedReason>, rule: models::CodeScanningAlertRuleSummary, tool: models::CodeScanningAnalysisTool, most_recent_instance: models::CodeScanningAlertInstance, repository: models::SimpleRepository) -> CodeScanningOrganizationAlertItems {
