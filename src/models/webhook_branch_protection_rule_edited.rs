...
impl WebhookBranchProtectionRuleEdited {
    pub fn new(action: Action, repository: models::RepositoryWebhooks, rule: models::WebhooksRule, sender: models::SimpleUserWebhooks) -> WebhookBranchProtectionRuleEdited {
