...
pub struct App16 {
    ...
    pub permissions: Option<Box<models::App2Permissions>>,
...
impl App16 {
    ...
    pub fn new(created_at: Option<String>, description: Option<String>, external_url: Option<String>, html_url: String, id: Option<i32>, name: String, node_id: String, owner: Option<models::User>, updated_at: Option<String>) -> App16 {
        App16 {
            created_at,
            description,
            events: None,
