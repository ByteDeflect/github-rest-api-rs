...
impl WebhookPackageUpdatedPackage {
    ...
    pub fn new(created_at: String, description: Option<String>, ecosystem: String, html_url: String, id: i32, name: String, namespace: String, owner: Option<models::User>, package_type: String, package_version: models::WebhookPackageUpdatedPackagePackageVersion, registry: Option<models::WebhookPackagePublishedPackageRegistry>, updated_at: String) -> WebhookPackageUpdatedPackage {
