...
impl WebhookProjectsV2ItemRestored {
    pub fn new(action: Action, changes: models::WebhooksProjectChanges, organization: models::OrganizationSimpleWebhooks, projects_v2_item: models::ProjectsV2Item, sender: models::SimpleUserWebhooks) -> WebhookProjectsV2ItemRestored {
