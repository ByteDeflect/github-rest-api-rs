...
pub struct WebhookInstallationCreated {
    ...
    pub requester: Option<Option<Box<models::WebhooksUser>>>,
    #[serde(rename = "sender")]
    pub sender: Box<models::SimpleUserWebhooks>,
}

impl WebhookInstallationCreated {
    pub fn new(action: Action, installation: models::Installation, sender: models::SimpleUserWebhooks) -> WebhookInstallationCreated {
