...
impl SimplePullRequest1 {
    pub fn new(_links: models::WebhooksPullRequest5Links, active_lock_reason: Option<ActiveLockReason>, assignee: Option<models::User3>, assignees: Vec<models::User3>, author_association: AuthorAssociation, auto_merge: Option<models::PullRequestAutoMerge>, base: models::SimplePullRequest1Base, body: Option<String>, closed_at: Option<String>, comments_url: String, commits_url: String, created_at: String, diff_url: String, draft: bool, head: models::SimplePullRequest1Head, html_url: String, id: i32, issue_url: String, labels: Vec<models::Label>, locked: bool, merge_commit_sha: Option<String>, merged_at: Option<String>, milestone: Option<models::Milestone>, node_id: String, number: i32, patch_url: String, requested_reviewers: Vec<models::PullRequestRequestedReviewersInner>, requested_teams: Vec<models::Team>, review_comment_url: String, review_comments_url: String, state: State, statuses_url: String, title: String, updated_at: String, url: String, user: Option<models::User2>) -> SimplePullRequest1 {
        SimplePullRequest1 {
