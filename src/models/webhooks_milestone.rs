...
pub struct WebhooksMilestone {
    ...
    pub creator: Option<Box<models::User3>>,
...
impl WebhooksMilestone {
    ...
    pub fn new(closed_at: Option<String>, closed_issues: i32, created_at: String, creator: Option<models::User3>, description: Option<String>, due_on: Option<String>, html_url: String, id: i32, labels_url: String, node_id: String, number: i32, open_issues: i32, state: State, title: String, updated_at: String, url: String) -> WebhooksMilestone {
        WebhooksMilestone {
            closed_at,
            closed_issues,
            created_at,
