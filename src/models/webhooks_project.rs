...
impl WebhooksProject {
    pub fn new(body: Option<String>, columns_url: String, created_at: String, creator: Option<models::User>, html_url: String, id: i32, name: String, node_id: String, number: i32, owner_url: String, state: State, updated_at: String, url: String) -> WebhooksProject {
        WebhooksProject {
            body,
            columns_url,
            created_at,
