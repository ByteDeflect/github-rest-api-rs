...
pub struct WebhookWorkflowJobInProgress {
    ...
    pub workflow_job: Box<models::WebhookWorkflowJobInProgressWorkflowJob>,
...
impl WebhookWorkflowJobInProgress {
    pub fn new(action: Action, repository: models::RepositoryWebhooks, sender: models::SimpleUserWebhooks, workflow_job: models::WebhookWorkflowJobInProgressWorkflowJob) -> WebhookWorkflowJobInProgress {
