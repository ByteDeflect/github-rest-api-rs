...
impl WebhookStatusCommit {
    pub fn new(author: Option<models::User5>, comments_url: String, commit: models::WebhookStatusCommitCommit, committer: Option<models::User5>, html_url: String, node_id: String, parents: Vec<models::WebhookStatusCommitParentsInner>, sha: String, url: String) -> WebhookStatusCommit {
        WebhookStatusCommit {
