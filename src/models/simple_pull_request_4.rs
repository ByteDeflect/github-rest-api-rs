...
pub struct SimplePullRequest4 {
    ...
    pub auto_merge: Option<Box<models::PullRequestAutoMerge1>>,
    #[serde(rename = "base")]
    pub base: Box<models::SimplePullRequest3Base>,
    ...
    pub draft: bool,
    #[serde(rename = "head")]
    pub head: Box<models::SimplePullRequest3Base>,
...
impl SimplePullRequest4 {
    pub fn new(_links: models::WebhooksPullRequest5Links, active_lock_reason: Option<ActiveLockReason>, assignee: Option<models::User>, assignees: Vec<models::User>, author_association: AuthorAssociation, auto_merge: Option<models::PullRequestAutoMerge1>, base: models::SimplePullRequest3Base, body: Option<String>, closed_at: Option<String>, comments_url: String, commits_url: String, created_at: String, diff_url: String, draft: bool, head: models::SimplePullRequest3Base, html_url: String, id: i32, issue_url: String, labels: Vec<models::Label>, locked: bool, merge_commit_sha: Option<String>, merged_at: Option<String>, milestone: Option<models::Milestone1>, node_id: String, number: i32, patch_url: String, requested_reviewers: Vec<models::WebhooksPullRequest5RequestedReviewersInner>, requested_teams: Vec<models::Team>, review_comment_url: String, review_comments_url: String, state: State, statuses_url: String, title: String, updated_at: String, url: String, user: Option<models::User1>) -> SimplePullRequest4 {
        SimplePullRequest4 {
