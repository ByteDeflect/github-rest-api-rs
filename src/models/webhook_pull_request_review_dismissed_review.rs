...
impl WebhookPullRequestReviewDismissedReview {
    ...
    pub fn new(_links: models::WebhooksReviewLinks, author_association: AuthorAssociation, body: Option<String>, commit_id: String, html_url: String, id: i32, node_id: String, pull_request_url: String, state: State, submitted_at: String, user: Option<models::User2>) -> WebhookPullRequestReviewDismissedReview {
