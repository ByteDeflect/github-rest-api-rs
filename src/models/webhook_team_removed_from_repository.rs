...
impl WebhookTeamRemovedFromRepository {
    pub fn new(action: Action, organization: models::OrganizationSimpleWebhooks, sender: models::SimpleUserWebhooks, team: models::WebhooksTeam1) -> WebhookTeamRemovedFromRepository {
