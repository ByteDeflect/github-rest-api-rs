...
impl App8 {
    ...
    pub fn new(created_at: Option<String>, description: Option<String>, external_url: Option<String>, html_url: String, id: Option<i32>, name: String, node_id: String, owner: Option<models::User>, updated_at: Option<String>) -> App8 {
        App8 {
            created_at,
            description,
            events: None,
