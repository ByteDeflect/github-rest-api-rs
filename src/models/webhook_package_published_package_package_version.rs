...
pub struct WebhookPackagePublishedPackagePackageVersion {
    ...
    pub author: Option<Option<Box<models::User>>>,
    ...
    #[serde(rename = "container_metadata", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub container_metadata: Option<Option<Box<models::WebhookPackagePublishedPackagePackageVersionContainerMetadata>>>,
    ...
    pub npm_metadata: Option<Option<Box<models::WebhookPackagePublishedPackagePackageVersionNpmMetadata>>>,
    #[serde(rename = "nuget_metadata", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub nuget_metadata: Option<Option<Vec<models::WebhookPackagePublishedPackagePackageVersionNugetMetadataInner>>>,
    #[serde(rename = "package_files")]
    pub package_files: Vec<models::WebhookPackagePublishedPackagePackageVersionPackageFilesInner>,
    ...
    pub release: Option<Box<models::WebhookPackagePublishedPackagePackageVersionRelease>>,
