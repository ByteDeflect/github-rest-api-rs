...
pub struct Issue8 {
    ...
    pub assignee: Option<Option<Box<models::User>>>,
    ...
    pub labels: Option<Vec<models::Label1>>,
    ...
    pub performed_via_github_app: Option<Option<Box<models::App16>>>,
...
impl Issue8 {
    ...
    pub fn new(active_lock_reason: Option<ActiveLockReason>, assignees: Vec<models::User3>, author_association: AuthorAssociation, body: Option<String>, closed_at: Option<String>, comments: i32, comments_url: String, created_at: String, events_url: String, html_url: String, id: i64, labels_url: String, milestone: Option<models::Milestone>, node_id: String, number: i32, reactions: models::Reactions, repository_url: String, state: State, title: String, updated_at: String, url: String, user: Option<models::User2>) -> Issue8 {
        Issue8 {
            active_lock_reason,
            assignee: None,
            assignees,
