...
pub struct Issue5 {
    ...
    pub performed_via_github_app: Option<Option<Box<models::App15>>>,
...
impl Issue5 {
    ...
    pub fn new(active_lock_reason: Option<ActiveLockReason>, assignees: Vec<models::User>, author_association: AuthorAssociation, body: Option<String>, closed_at: Option<String>, comments: i32, comments_url: String, created_at: String, events_url: String, html_url: String, id: i64, labels_url: String, milestone: Option<models::Milestone>, node_id: String, number: i32, reactions: models::Reactions, repository_url: String, title: String, updated_at: String, url: String, user: Option<models::User1>) -> Issue5 {
        Issue5 {
            active_lock_reason,
            assignee: None,
            assignees,
