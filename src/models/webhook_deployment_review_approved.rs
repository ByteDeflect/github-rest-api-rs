...
pub struct WebhookDeploymentReviewApproved {
    ...
    pub workflow_job_runs: Option<Vec<models::WebhookDeploymentReviewApprovedWorkflowJobRunsInner>>,
    #[serde(rename = "workflow_run", deserialize_with = "Option::deserialize")]
    pub workflow_run: Option<Box<models::DeploymentWorkflowRun1>>,
}

impl WebhookDeploymentReviewApproved {
    pub fn new(action: Action, organization: models::OrganizationSimpleWebhooks, repository: models::RepositoryWebhooks, sender: models::SimpleUserWebhooks, since: String, workflow_run: Option<models::DeploymentWorkflowRun1>) -> WebhookDeploymentReviewApproved {
