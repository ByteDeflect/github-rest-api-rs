...
pub struct WebhookPullRequestReviewCommentCreatedPullRequest {
    ...
    #[serde(rename = "head")]
    pub head: Box<models::WebhookPullRequestReviewCommentCreatedPullRequestHead>,
