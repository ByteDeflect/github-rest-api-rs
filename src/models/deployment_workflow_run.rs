...
pub struct DeploymentWorkflowRun {
    ...
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "triggering_actor", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub triggering_actor: Option<Option<Box<models::User>>>,
