...
impl WebhookSubIssuesParentIssueAdded {
    pub fn new(action: Action, parent_issue_id: f64, parent_issue: models::Issue, parent_issue_repo: models::Repository, sub_issue_id: f64, sub_issue: models::Issue) -> WebhookSubIssuesParentIssueAdded {
