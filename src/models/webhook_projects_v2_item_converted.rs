...
impl WebhookProjectsV2ItemConverted {
    pub fn new(action: Action, changes: models::WebhookProjectsV2ItemConvertedChanges, organization: models::OrganizationSimpleWebhooks, projects_v2_item: models::ProjectsV2Item, sender: models::SimpleUserWebhooks) -> WebhookProjectsV2ItemConverted {
