...
pub struct WebhookCodeScanningAlertAppearedInBranchAlert {
    ...
    pub dismissed_by: Option<Box<models::User>>,
...
impl WebhookCodeScanningAlertAppearedInBranchAlert {
    ...
    pub fn new(created_at: String, dismissed_at: Option<String>, dismissed_by: Option<models::User>, dismissed_reason: Option<DismissedReason>, html_url: String, number: i32, rule: models::WebhookCodeScanningAlertAppearedInBranchAlertRule, state: State, tool: models::WebhookCodeScanningAlertAppearedInBranchAlertTool, url: String) -> WebhookCodeScanningAlertAppearedInBranchAlert {
