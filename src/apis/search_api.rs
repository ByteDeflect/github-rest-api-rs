...
pub async fn search_slash_issues_and_pull_requests(configuration: &configuration::Configuration, q: &str, sort: Option<&str>, order: Option<&str>, per_page: Option<i32>, page: Option<i32>) -> Result<models::SearchIssuesAndPullRequests200Response, Error<SearchSlashIssuesAndPullRequestsError>> {
    let local_var_configuration = configuration;
