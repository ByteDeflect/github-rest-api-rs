...
pub async fn repos_slash_add_app_access_restrictions(configuration: &configuration::Configuration, owner: &str, repo: &str, branch: &str, repos_set_app_access_restrictions_request: Option<models::ReposSetAppAccessRestrictionsRequest>) -> Result<Vec<models::Integration>, Error<ReposSlashAddAppAccessRestrictionsError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_add_user_access_restrictions(configuration: &configuration::Configuration, owner: &str, repo: &str, branch: &str, repos_set_user_access_restrictions_request: Option<models::ReposSetUserAccessRestrictionsRequest>) -> Result<Vec<models::SimpleUser>, Error<ReposSlashAddUserAccessRestrictionsError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_cancel_pages_deployment(configuration: &configuration::Configuration, owner: &str, repo: &str, pages_deployment_id: models::ActionsGetWorkflowWorkflowIdParameter) -> Result<(), Error<ReposSlashCancelPagesDeploymentError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_get_org_rule_suites(configuration: &configuration::Configuration, org: &str, r#ref: Option<&str>, repository_name: Option<i32>, time_period: Option<&str>, actor_name: Option<&str>, rule_suite_result: Option<&str>, per_page: Option<i32>, page: Option<i32>) -> Result<Vec<models::RuleSuitesInner>, Error<ReposSlashGetOrgRuleSuitesError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_get_org_rulesets(configuration: &configuration::Configuration, org: &str, per_page: Option<i32>, page: Option<i32>) -> Result<Vec<models::RepositoryRuleset>, Error<ReposSlashGetOrgRulesetsError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_get_pages_deployment(configuration: &configuration::Configuration, owner: &str, repo: &str, pages_deployment_id: models::ActionsGetWorkflowWorkflowIdParameter) -> Result<models::PagesDeploymentStatus, Error<ReposSlashGetPagesDeploymentError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_get_repo_rulesets(configuration: &configuration::Configuration, owner: &str, repo: &str, per_page: Option<i32>, page: Option<i32>, includes_parents: Option<bool>) -> Result<Vec<models::RepositoryRuleset>, Error<ReposSlashGetRepoRulesetsError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_list_attestations(configuration: &configuration::Configuration, owner: &str, repo: &str, subject_digest: &str, per_page: Option<i32>, before: Option<&str>, after: Option<&str>) -> Result<models::OrgsListAttestations200Response, Error<ReposSlashListAttestationsError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_list_webhook_deliveries(configuration: &configuration::Configuration, owner: &str, repo: &str, hook_id: i32, per_page: Option<i32>, cursor: Option<&str>, redelivery: Option<bool>) -> Result<Vec<models::HookDeliveryItem>, Error<ReposSlashListWebhookDeliveriesError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_remove_app_access_restrictions(configuration: &configuration::Configuration, owner: &str, repo: &str, branch: &str, repos_set_app_access_restrictions_request: Option<models::ReposSetAppAccessRestrictionsRequest>) -> Result<Vec<models::Integration>, Error<ReposSlashRemoveAppAccessRestrictionsError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_set_app_access_restrictions(configuration: &configuration::Configuration, owner: &str, repo: &str, branch: &str, repos_set_app_access_restrictions_request: Option<models::ReposSetAppAccessRestrictionsRequest>) -> Result<Vec<models::Integration>, Error<ReposSlashSetAppAccessRestrictionsError>> {
    let local_var_configuration = configuration;
...
pub async fn repos_slash_set_user_access_restrictions(configuration: &configuration::Configuration, owner: &str, repo: &str, branch: &str, repos_set_user_access_restrictions_request: Option<models::ReposSetUserAccessRestrictionsRequest>) -> Result<Vec<models::SimpleUser>, Error<ReposSlashSetUserAccessRestrictionsError>> {
    let local_var_configuration = configuration;
