...
pub async fn users_slash_list_attestations(configuration: &configuration::Configuration, username: &str, subject_digest: &str, per_page: Option<i32>, before: Option<&str>, after: Option<&str>) -> Result<models::UsersListAttestations200Response, Error<UsersSlashListAttestationsError>> {
    let local_var_configuration = configuration;
