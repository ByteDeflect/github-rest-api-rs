...
pub async fn code_scanning_slash_list_alert_instances(configuration: &configuration::Configuration, owner: &str, repo: &str, alert_number: i32, page: Option<i32>, per_page: Option<i32>, r#ref: Option<&str>) -> Result<Vec<models::CodeScanningAlertInstance>, Error<CodeScanningSlashListAlertInstancesError>> {
    let local_var_configuration = configuration;
...
pub async fn code_scanning_slash_list_alerts_for_repo(configuration: &configuration::Configuration, owner: &str, repo: &str, tool_name: Option<&str>, tool_guid: Option<&str>, page: Option<i32>, per_page: Option<i32>, r#ref: Option<&str>, direction: Option<&str>, sort: Option<&str>, state: Option<models::CodeScanningAlertStateQuery>, severity: Option<models::CodeScanningAlertSeverity>) -> Result<Vec<models::CodeScanningAlertItems>, Error<CodeScanningSlashListAlertsForRepoError>> {
    let local_var_configuration = configuration;
