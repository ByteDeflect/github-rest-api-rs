...
pub async fn orgs_slash_create_or_update_custom_property(configuration: &configuration::Configuration, org: &str, custom_property_name: &str, orgs_create_or_update_custom_property_request: models::OrgsCreateOrUpdateCustomPropertyRequest) -> Result<models::CustomProperty, Error<OrgsSlashCreateOrUpdateCustomPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_list_attestations(configuration: &configuration::Configuration, org: &str, subject_digest: &str, per_page: Option<i32>, before: Option<&str>, after: Option<&str>) -> Result<models::OrgsListAttestations200Response, Error<OrgsSlashListAttestationsError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_list_webhook_deliveries(configuration: &configuration::Configuration, org: &str, hook_id: i32, per_page: Option<i32>, cursor: Option<&str>, redelivery: Option<bool>) -> Result<Vec<models::HookDeliveryItem>, Error<OrgsSlashListWebhookDeliveriesError>> {
    let local_var_configuration = configuration;
