...
> Vec<models::RepositoryRuleset> repos_slash_get_org_rulesets(org, per_page, page)
...
> Vec<models::RepositoryRuleset> repos_slash_get_repo_rulesets(owner, repo, per_page, page, includes_parents)
...
> models::OrgsListAttestations200Response repos_slash_list_attestations(owner, repo, subject_digest, per_page, before, after)
List attestations
...
> Vec<models::HookDeliveryItem> repos_slash_list_webhook_deliveries(owner, repo, hook_id, per_page, cursor, redelivery)
