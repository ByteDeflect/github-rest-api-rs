...
**base** | [**models::WebhooksPullRequest5Base**](webhooks_pull_request_5_base.md) |  | 
**body** | Option<**String**> |  | 
...
**head** | [**models::WebhooksPullRequest5Base**](webhooks_pull_request_5_base.md) |  | 
**html_url** | **String** |  | 
**id** | **i32** |  | 
**issue_url** | **String** |  | 
...
**merged_by** | Option<[**models::User3**](User_3.md)> |  | [optional]
